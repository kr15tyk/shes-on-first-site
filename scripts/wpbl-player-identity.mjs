...
const reviewedIds = [
  ...
  ['n6fptazerna1mwyt', '70rhe3ul6tticdxu'], // Addisyn Baird (LA): feed reassigned her source ID; new ID debuts 2026-09-19, uniform 17 continuity, no profile_url to join on
]
const reviewedNames = ['Diana Ibarra', "Claire O'Sullivan", 'Paloma Benach', 'Suzu Narasaki', 'Olivia Bricker', 'Emi Saiki', 'Peyton Coria', 'Addisyn Baird']
